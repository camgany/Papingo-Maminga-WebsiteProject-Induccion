<template>
  <div class="navbar" :class="{ change_color: scrollPosition > 200 }">
    <a class="left">
      <img src="@/assets/img/PAPINGOMAMINGALOGO.png" />
    </a>
    <div class="center">
      <div class="logo">PAPINGOMAMINGA</div>
      <div class="navlink">
        <router-link class="nav-page" to="/">INICIO</router-link>
        <router-link class="nav-page" to="/women">MUJER</router-link>
        <router-link class="nav-page" to="/men">HOMBRE</router-link>
