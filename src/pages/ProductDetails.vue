<template>
  <div v-if="product" class="product">
    ...
    <div class="container">
      <div class="details">
        <p class="brand">{{ product.code }}</p>
        <h1 class="title">{{ product.title }}</h1>
        <p class="price">${{ product.price }}</p>
        <p class="description">{{ product.description }}</p>
        <form class="cart">
          <div v-if = "product.gender === 'men' || product.gender === 'women'">
           <select
            class="select"
            defaultValue="ceva"
            v-model="this.size"
        ...
        <div v-else>
          <p class="select" disable cursor="not-allowed">One size</p>
        </div>
...
export default {
  ...
  mounted() {
    ...
    } else if (this.gender == "jewerly") {
      this.product = this.$store.getters.getProductByIdJewerly(this.id);
    }
    else {
      this.product = this.$store.getters.getProductByIdBags(this.id);
    }
